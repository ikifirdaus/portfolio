...
<section class="content">
    {!! Form::model($data, ['method' => 'POST','route' => ['portfolioAdmin.update',$data->id], 'enctype'=>'multipart/form-data']) !!}
    @csrf
            ...
            <div class="card-body card-form">
                <form>
                    <div class="pt-3 pb-3">
                        ...
                        <div>
                            <img id="blah" src="{{ asset('/uploads/portfolio/'.$data->gambar) }}" alt="Preview" class="img-fluid" />
                        </div>
                    </div>
    
                    <div class="form-group pt-2">
                        <label for="formGroupExampleInput">Tanggal</label>
                        <input name="tanggal" type="date" class="form-control" id="formGroupExampleInput" placeholder="tanggal" value="{{ $data->tanggal }}">
                    </div>
                    ...
                    <div class="form-group pt-2">
                        ...
                        <textarea name="deskripsi_singkat" type="text" class="form-control" id="formGroupExampleInput2" placeholder="Description" rows="5">{{ $data->deskripsi_singkat }}</textarea>
                    </div>

                    <div class="form-group pt-2">
                        <label for="formGroupExampleInput">Deskripsi Singkat</label>
                        <textarea name="deskripsi_lengkap" type="text" class="form-control" id="formGroupExampleInput2" placeholder="Description" rows="5">{{ $data->deskripsi_lengkap }}</textarea>
                    </div>

                    <div class="form-group pt-2">
                        <label for="formGroupExampleInput">Url</label>
                        <input name="url" type="text" class="form-control" id="formGroupExampleInput" placeholder="link url" value="{{ $data->url }}">
                    </div>
