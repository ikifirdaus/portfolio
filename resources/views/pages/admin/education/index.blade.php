    ...
    <div class="container section-header-banner">
        ...
        <div class="card shadow border-0 ">
            <div class="card-header py-3 d-flex">
                <h6 class="font-weight-bold text-secondary">EDUCATION</h6>
            </div>
                                ...
                                <td style="white-space: nowrap">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <button class="border-0" style="background: transparent;">
                                            <a href="{{ route('education.edit', $item->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </button>
                                            ...
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    {!! Form::open(['route' => ['education.delete',$item->id], 'method' => 'delete']) !!}
