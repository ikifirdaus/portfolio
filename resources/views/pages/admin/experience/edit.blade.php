...
<section class="content">
    {!! Form::model($data, ['method' => 'POST','route' => ['experience.update',$data->id], 'enctype'=>'multipart/form-data']) !!}
    @csrf
    <div class="container section-header-banner pb-5">
        <!-- DataTales Example -->
        <div class="card shadow border-0 ">
            <div class="card-header py-3">
                <h6 class="font-weight-bold text-secondary">ADD EXPERIENCE</h6>
            </div>
            ...
            <div class="card-body card-form">
                <form>
                    ...
                    <div class="form-group pt-2">
                        ...
                        <input name="tanggal" type="text" class="form-control" id="formGroupExampleInput" placeholder="contoh: 2020 - Present" value="{{ $data->tanggal }}">
                    </div>
