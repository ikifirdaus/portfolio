...
<section class="content">
    {!! Form::model($data, ['method' => 'POST','route' => ['services.update',$data->id], 'enctype'=>'multipart/form-data']) !!}
    @csrf
                ...
                <form>
                    <div class="pt-3 pb-3">
                        ...
                        <div class="custom-file">
                          <input name="gambar_icon" type="file" class="custom-file-input" id="imgInp">
                          <label class="custom-file-label" for="inputGroupFile01">Add File</label>
                        </div>
                        </div>
    
                        <div>
                            <img id="blah" src="{{ asset('uploads/services/'.$data->gambar_icon) }}" alt="Preview" class="img-fluid" />
                        </div>
                    </div>
