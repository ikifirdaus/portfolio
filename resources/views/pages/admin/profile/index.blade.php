    ...
    <div class="container section-header-banner">
        ...
        <div class="card shadow border-0 ">
            <div class="card-header py-3 d-flex">
                <h6 class="font-weight-bold text-secondary">PROFILE</h6>
            </div>
            
            <div class="card-body">
                {{-- <div class="pb-3 d-flex">
                    <a href="{{ route('profile.create') }}" class="btn btn-homedashboard ml-auto rounded-2">
                        <i class="fa-solid fa-plus"></i><span> Add Profile</span>
                    </a>
                </div> --}}
                    ...
                    <table class="table table-striped" id="myTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr id="row{{ $item->id }}">
                                ...
                                <td><img src="{{ asset('/uploads/profile/'.$item->gambar_profile) }}" alt="" width="100px" height="100px"></td>
                                <td>
                                ...
                                <td style="white-space: nowrap">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <button class="border-0" style="background: transparent;">
                                            <a href="{{ route('profile.edit', $item->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </button>
                                            ...
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    {!! Form::open(['route' => ['profile.delete',$item->id], 'method' => 'delete']) !!}
